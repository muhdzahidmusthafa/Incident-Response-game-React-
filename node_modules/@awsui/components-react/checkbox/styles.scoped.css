...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
div.awsui_root_k2y2q_1p2mf_93:not(#\9) {
...
.awsui_checkbox-control_k2y2q_1p2mf_105:not(#\9) {
  margin-top: calc((var(--font-body-m-line-height-i7xxvv, 22px) - var(--size-control-eyly4k, 14px)) / 2);
  min-height: var(--size-control-eyly4k, 14px);
  min-width: var(--size-control-eyly4k, 14px);
  height: var(--size-control-eyly4k, 14px);
  width: var(--size-control-eyly4k, 14px);
}

.awsui_input_k2y2q_1p2mf_113[data-awsui-focus-visible=true]:not(#\9):focus {
  /* stylelint-disable-next-line selector-max-type -- Can't access the outline class from focus-visible */
}
.awsui_input_k2y2q_1p2mf_113[data-awsui-focus-visible=true]:not(#\9):focus + div {
  position: relative;
}
.awsui_input_k2y2q_1p2mf_113[data-awsui-focus-visible=true]:not(#\9):focus + div {
...
.awsui_input_k2y2q_1p2mf_113[data-awsui-focus-visible=true]:not(#\9):focus + div::before {
  content: " ";
  display: block;
  position: absolute;
  left: calc(-1 * 2px);

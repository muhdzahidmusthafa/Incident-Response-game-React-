...
.awsui_input_2rhyz_25nxz_97.awsui_input-readonly_2rhyz_25nxz_118:not(#\9) {
  background-color: var(--color-background-input-default-ewlytp, #ffffff);
  border: var(--border-field-width-y6x4sn, 1px) solid var(--color-border-input-disabled-ek5o0x, #eaeded);
}
.awsui_input_2rhyz_25nxz_97:not(#\9)::-webkit-input-placeholder {
  color: var(--color-text-input-placeholder-rtvjp5, #687078);
  font-style: italic;
  -webkit-user-select: none;
          user-select: none;
}
.awsui_input_2rhyz_25nxz_97:not(#\9)::-ms-input-placeholder {
  color: var(--color-text-input-placeholder-rtvjp5, #687078);
  font-style: italic;
}
.awsui_input_2rhyz_25nxz_97:not(#\9)::-moz-placeholder {
  color: var(--color-text-input-placeholder-rtvjp5, #687078);
  font-style: italic;
  opacity: 1;
}
...
.awsui_input_2rhyz_25nxz_97:not(#\9):focus {
...
.awsui_input_2rhyz_25nxz_97:not(#\9):disabled {
...
.awsui_input_2rhyz_25nxz_97:not(#\9):disabled::-webkit-input-placeholder {
  color: var(--color-text-input-placeholder-disabled-60yf1a, #687078);
  -webkit-user-select: none;
          user-select: none;
}
.awsui_input_2rhyz_25nxz_97:not(#\9):disabled::-ms-input-placeholder {
  color: var(--color-text-input-placeholder-disabled-60yf1a, #687078);
}
.awsui_input_2rhyz_25nxz_97:not(#\9):disabled::-moz-placeholder {
  color: var(--color-text-input-placeholder-disabled-60yf1a, #687078);
  opacity: 1;
}
.awsui_input_2rhyz_25nxz_97:not(#\9):disabled:-ms-input-placeholder {
...
.awsui_input_2rhyz_25nxz_97:not(#\9):invalid {
  box-shadow: none;
}
.awsui_input_2rhyz_25nxz_97.awsui_input-invalid_2rhyz_25nxz_179:not(#\9) {
...
.awsui_input_2rhyz_25nxz_97.awsui_input-invalid_2rhyz_25nxz_179:not(#\9):focus {
...
.awsui_input_2rhyz_25nxz_97.awsui_input-invalid_2rhyz_25nxz_179.awsui_input-has-icon-left_2rhyz_25nxz_190:not(#\9) {
  padding-left: calc(
        var(--space-field-icon-offset-alfd6o, 32px) - (var(--border-invalid-width-glmng5, 4px) - var(--border-field-width-y6x4sn, 1px))
      );
}
.awsui_input_2rhyz_25nxz_97.awsui_input-type-search_2rhyz_25nxz_195:not(#\9) {
  box-sizing: border-box;
  -webkit-appearance: none;
  /* stylelint-disable-line plugin/no-unsupported-browser-features */
}
.awsui_input_2rhyz_25nxz_97.awsui_input-type-search_2rhyz_25nxz_195:not(#\9)::-ms-clear {
  display: none;
}
.awsui_input_2rhyz_25nxz_97.awsui_input-type-search_2rhyz_25nxz_195:not(#\9)::-webkit-search-decoration {
  -webkit-appearance: none;
  /* stylelint-disable-line plugin/no-unsupported-browser-features */
}
.awsui_input_2rhyz_25nxz_97.awsui_input-type-search_2rhyz_25nxz_195:not(#\9)::-webkit-search-cancel-button {
  display: none;
}
.awsui_input_2rhyz_25nxz_97.awsui_input-has-icon-left_2rhyz_25nxz_190:not(#\9) {
  padding-left: var(--space-field-icon-offset-alfd6o, 32px);
}
.awsui_input_2rhyz_25nxz_97.awsui_input-has-icon-right_2rhyz_25nxz_213:not(#\9) {
  padding-right: var(--space-field-icon-offset-alfd6o, 32px);
}
.awsui_input_2rhyz_25nxz_97.awsui_input-has-no-border-radius_2rhyz_25nxz_216:not(#\9) {
  border-radius: var(--border-radius-dropdown-0c284d, 0px);
}

.awsui_input-container_2rhyz_25nxz_220:not(#\9) {
  display: flex;
  position: relative;
}

.awsui_input-icon_2rhyz_25nxz_225:not(#\9) {
  position: absolute;
}
.awsui_input-icon_2rhyz_25nxz_225:not(#\9):not(.awsui_input-icon-hoverable_2rhyz_25nxz_228) {
  pointer-events: none;
}

.awsui_input-icon-left_2rhyz_25nxz_232:not(#\9) {
  left: var(--space-field-horizontal-z3i1c8, 8px);
  top: calc(50% - var(--font-body-m-line-height-i7xxvv, 22px) / 2);
}

.awsui_input-icon-right_2rhyz_25nxz_237:not(#\9) {
  right: var(--space-field-horizontal-z3i1c8, 8px);
  top: calc(50% - var(--font-body-m-line-height-i7xxvv, 22px) / 2);
  color: var(--color-text-button-inline-icon-default-qhj7jl, #545b64);
}

.awsui_input-icon-hoverable_2rhyz_25nxz_228:not(#\9) {
  cursor: pointer;
}
.awsui_input-icon-hoverable_2rhyz_25nxz_228:not(#\9):hover {

...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
.awsui_series_y1yrh_2df46_93 > rect:not(#\9) {
...
.awsui-motion-disabled .awsui_series_y1yrh_2df46_93 > rect:not(#\9), .awsui-mode-entering .awsui_series_y1yrh_2df46_93 > rect:not(#\9) {
  animation: none;
  transition: none;
}
...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
.awsui_root_y1yrh_2df46_111:not(#\9) {
...
.awsui_has-default-filter_y1yrh_2df46_124 > :not(#\9):first-child {
  flex: 280px 0 1;
}

.awsui_chart-container_y1yrh_2df46_128:not(#\9) {
  display: flex;
  width: 100%;
  flex-direction: column;
}

.awsui_chart-container__vertical_y1yrh_2df46_134:not(#\9) {
  display: flex;
  flex-direction: column;
  width: 100%;
}

.awsui_chart-container__horizontal_y1yrh_2df46_140:not(#\9) {
  display: flex;
}

.awsui_content_y1yrh_2df46_144:not(#\9) {
  display: flex;
  position: relative;
...
.awsui_content--reserve-filter_y1yrh_2df46_151:not(#\9) {
  margin-top: calc(2 * var(--font-body-m-line-height-i7xxvv, 22px));
}

.awsui_content--reserve-legend_y1yrh_2df46_155:not(#\9) {
  margin-bottom: calc(2 * var(--font-body-m-line-height-i7xxvv, 22px));
}

.awsui_series_y1yrh_2df46_93:not(#\9) {
  display: block;
...
.awsui_series--highlighted_y1yrh_2df46_167:not(#\9) {
  /* used in test-utils */
}

.awsui_series--dimmed_y1yrh_2df46_171:not(#\9) {
  opacity: 0.3;
}

.awsui_series--threshold_y1yrh_2df46_175:not(#\9) {
  stroke-dasharray: var(--border-line-chart-dash-array-4wa4ab, 3 5);
  stroke-width: var(--border-line-chart-width-nj0hc5, 2px);
}

.awsui_popover-divider_y1yrh_2df46_180:not(#\9) {

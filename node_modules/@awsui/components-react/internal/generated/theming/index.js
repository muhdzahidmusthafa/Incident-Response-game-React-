export var preset = {
  "theme": {
    ...
    "tokens": {
      ...
      "colorBackgroundSegmentActive": {
        "light": "{colorBackgroundButtonNormalActive}",
        "dark": "{colorBackgroundButtonNormalActive}"
      },
      ...
      "spaceTextGridVertical": {
        "comfortable": "{spaceGridGutter}",
        "compact": "{spaceGridGutter}"
      },
      "spaceScaled2xNone": {
  ...
  "propertiesMap": {
    ...
    "colorBlue100": "--color-blue-100-46h950",
    "colorBlue200": "--color-blue-200-9opekl",
    "colorBlue300": "--color-blue-300-1huqik",
    "colorBlue400": "--color-blue-400-zx8261",
    "colorBlue500": "--color-blue-500-bzs2vn",
    "colorBlue600": "--color-blue-600-rw7xxu",
    "colorBlue700": "--color-blue-700-stwspw",
    "colorBlue800": "--color-blue-800-wkg93v",
    "colorBlue900": "--color-blue-900-ity63b",
    "colorBlueOpaque": "--color-blue-opaque-n04eob",
    "colorGreen100": "--color-green-100-orvl77",
    "colorGreen500": "--color-green-500-lc8lqm",
    "colorGreen600": "--color-green-600-mgwxfu",
    "colorGreen700": "--color-green-700-mxknm4",
    "colorGreen900": "--color-green-900-ka0g24",
    "colorGrey100": "--color-grey-100-33j49h",
    "colorGrey150": "--color-grey-150-hchpvs",
    "colorGrey200": "--color-grey-200-gku20g",
    "colorGrey300": "--color-grey-300-bsdaby",
    "colorGrey400": "--color-grey-400-97y71j",
    "colorGrey450": "--color-grey-450-6ysehh",
    "colorGrey500": "--color-grey-500-wjratr",
    "colorGrey550": "--color-grey-550-5z54al",
    "colorGrey600": "--color-grey-600-sjxoe1",
    "colorGrey650": "--color-grey-650-xngd5i",
    "colorGrey700": "--color-grey-700-q1mpms",
    "colorGrey750": "--color-grey-750-qfbzd0",
    "colorGrey800": "--color-grey-800-xzqlpw",
    "colorGrey900": "--color-grey-900-fh8fhl",
    ...
    "colorRed100": "--color-red-100-ihp7iv",
    "colorRed500": "--color-red-500-pkn0gn",
    "colorRed600": "--color-red-600-d4j8bd",
    "colorRed700": "--color-red-700-xz5w9m",
    "colorRed900": "--color-red-900-2lnkl3",
    ...
    "colorChartsBlue2300": "--color-charts-blue-2-300-b0dh81",
    ...
    "colorChartsStatusNeutral": "--color-charts-status-neutral-ck671y",
    "colorChartsThresholdNegative": "--color-charts-threshold-negative-mu6ykn",
    "colorChartsThresholdPositive": "--color-charts-threshold-positive-xktr7h",
    "colorChartsThresholdInfo": "--color-charts-threshold-info-dho5hp",
    "colorChartsThresholdNeutral": "--color-charts-threshold-neutral-qybece",
    "colorChartsLineGrid": "--color-charts-line-grid-zjz2dj",
    "colorChartsLineTick": "--color-charts-line-tick-qwh0yx",
    "colorChartsLineAxis": "--color-charts-line-axis-wprqas",
    "colorChartsPaletteCategorical1": "--color-charts-palette-categorical-1-ivmh5s",
    ...
    "colorGreyOpaque70": "--color-grey-opaque-70-ysvzho",
    "colorGreyOpaque80": "--color-grey-opaque-80-g1t061",
    "colorGreyOpaque90": "--color-grey-opaque-90-xhnfbb",
    "colorGreyTransparent": "--color-grey-transparent-7xx705",
    "colorGreyTransparentHeavy": "--color-grey-transparent-heavy-37tk5h",
    "colorGreyTransparentLight": "--color-grey-transparent-light-yryfng",
    "colorBackgroundButtonLinkActive": "--color-background-button-link-active-b801wp",
    "colorBackgroundButtonLinkHover": "--color-background-button-link-hover-sqd83h",
    "colorBackgroundButtonNormalActive": "--color-background-button-normal-active-l3mgva",
    "colorBackgroundButtonNormalDefault": "--color-background-button-normal-default-i32hou",
    "colorBackgroundButtonNormalDisabled": "--color-background-button-normal-disabled-4hvzxe",
    "colorBackgroundButtonNormalHover": "--color-background-button-normal-hover-6vxqq6",
    "colorBackgroundButtonPrimaryActive": "--color-background-button-primary-active-gi3en9",
    "colorBackgroundButtonPrimaryDefault": "--color-background-button-primary-default-w02sje",
    "colorBackgroundButtonPrimaryDisabled": "--color-background-button-primary-disabled-2xivjm",
    "colorBackgroundButtonPrimaryHover": "--color-background-button-primary-hover-qli9yh",
    "colorBackgroundCalendarToday": "--color-background-calendar-today-wm2baz",
    "colorBackgroundCodeEditorGutterActiveLineDefault": "--color-background-code-editor-gutter-active-line-default-iqj33p",
    "colorBackgroundCodeEditorGutterActiveLineError": "--color-background-code-editor-gutter-active-line-error-stt57c",
    "colorBackgroundCodeEditorGutterDefault": "--color-background-code-editor-gutter-default-jzy459",
    "colorBackgroundCodeEditorLoading": "--color-background-code-editor-loading-sm80zv",
    "colorBackgroundCodeEditorPaneItemHover": "--color-background-code-editor-pane-item-hover-zlbhj7",
    "colorBackgroundCodeEditorStatusBar": "--color-background-code-editor-status-bar-ewmb7s",
    "colorBackgroundContainerContent": "--color-background-container-content-o88wxm",
    "colorBackgroundContainerHeader": "--color-background-container-header-g9rg0j",
    "colorBackgroundControlChecked": "--color-background-control-checked-dyuc53",
    "colorBackgroundControlDefault": "--color-background-control-default-8xmy94",
    "colorBackgroundControlDisabled": "--color-background-control-disabled-0y91m8",
    "colorBackgroundDropdownItemDefault": "--color-background-dropdown-item-default-9xpo3g",
    "colorBackgroundDropdownItemDimmed": "--color-background-dropdown-item-dimmed-qw48ma",
    "colorBackgroundDropdownItemFilterMatch": "--color-background-dropdown-item-filter-match-yd6eaz",
    "colorBackgroundDropdownItemHover": "--color-background-dropdown-item-hover-hgdj8r",
    "colorBackgroundDropdownItemSelected": "--color-background-dropdown-item-selected-w7iegd",
    "colorBackgroundHomeHeader": "--color-background-home-header-o5mjh6",
    "colorBackgroundInputDefault": "--color-background-input-default-ewlytp",
    "colorBackgroundInputDisabled": "--color-background-input-disabled-5vlksk",
    "colorBackgroundItemSelected": "--color-background-item-selected-fva7ca",
    "colorBackgroundLayoutMain": "--color-background-layout-main-q0tbxx",
    "colorBackgroundLayoutMobilePanel": "--color-background-layout-mobile-panel-7ihqdn",
    "colorBackgroundLayoutPanelContent": "--color-background-layout-panel-content-r9pdjh",
    "colorBackgroundLayoutPanelHover": "--color-background-layout-panel-hover-thdv3z",
    "colorBackgroundLayoutToggleActive": "--color-background-layout-toggle-active-d3zrnd",
    "colorBackgroundLayoutToggleDefault": "--color-background-layout-toggle-default-o9dqpo",
    "colorBackgroundLayoutToggleHover": "--color-background-layout-toggle-hover-5rvtea",
    "colorBackgroundLayoutToggleSelectedActive": "--color-background-layout-toggle-selected-active-3ftljk",
    "colorBackgroundLayoutToggleSelectedDefault": "--color-background-layout-toggle-selected-default-eduv1i",
    "colorBackgroundLayoutToggleSelectedHover": "--color-background-layout-toggle-selected-hover-vtsm2f",
    "colorBackgroundModalOverlay": "--color-background-modal-overlay-4qwcd5",
    "colorBackgroundNotificationBlue": "--color-background-notification-blue-rjpmdy",
    "colorBackgroundNotificationGreen": "--color-background-notification-green-uofkna",
    "colorBackgroundNotificationGrey": "--color-background-notification-grey-useve5",
    "colorBackgroundNotificationRed": "--color-background-notification-red-e2annb",
    "colorBackgroundPopover": "--color-background-popover-g6qj89",
    "colorBackgroundProgressBarContentDefault": "--color-background-progress-bar-content-default-kdvzje",
    "colorBackgroundProgressBarContentInFlash": "--color-background-progress-bar-content-in-flash-ka071o",
    "colorBackgroundProgressBarLayoutDefault": "--color-background-progress-bar-layout-default-teir10",
    "colorBackgroundProgressBarLayoutInFlash": "--color-background-progress-bar-layout-in-flash-phmfak",
    "colorBackgroundSegmentActive": "--color-background-segment-active-khzpn5",
    "colorBackgroundSegmentDefault": "--color-background-segment-default-bjnpj3",
    "colorBackgroundSegmentDisabled": "--color-background-segment-disabled-gcpwaz",
    "colorBackgroundSegmentHover": "--color-background-segment-hover-p2rkog",
    "colorBackgroundStatusError": "--color-background-status-error-h1a0iq",
    "colorBackgroundStatusInfo": "--color-background-status-info-yq3r41",
    "colorBackgroundStatusSuccess": "--color-background-status-success-cvmksn",
    "colorBackgroundStatusWarning": "--color-background-status-warning-1213z1",
    "colorBackgroundTableHeader": "--color-background-table-header-mryayf",
    "colorBackgroundTilesDisabled": "--color-background-tiles-disabled-o2m90z",
    "colorBackgroundToggleCheckedDisabled": "--color-background-toggle-checked-disabled-8l29jd",
    "colorBackgroundToggleDefault": "--color-background-toggle-default-0jqm1q",
    "colorBorderButtonNormalActive": "--color-border-button-normal-active-mkds03",
    "colorBorderButtonNormalDefault": "--color-border-button-normal-default-d57sob",
    "colorBorderButtonNormalDisabled": "--color-border-button-normal-disabled-7btdw0",
    "colorBorderButtonNormalHover": "--color-border-button-normal-hover-993ry7",
    "colorBorderButtonPrimaryDisabled": "--color-border-button-primary-disabled-exj7lz",
    "colorBorderCalendarGrid": "--color-border-calendar-grid-54zscx",
    "colorBorderCalendarGridSelectedFocusRing": "--color-border-calendar-grid-selected-focus-ring-vzbqhb",
    "colorBorderCodeEditorAceActiveLineLightTheme": "--color-border-code-editor-ace-active-line-light-theme-wvvw7v",
    "colorBorderCodeEditorAceActiveLineDarkTheme": "--color-border-code-editor-ace-active-line-dark-theme-48wwb3",
    "colorBorderCodeEditorDefault": "--color-border-code-editor-default-41f0h6",
    "colorBorderCodeEditorPaneItemHover": "--color-border-code-editor-pane-item-hover-ibrahi",
    "colorBorderContainerDivider": "--color-border-container-divider-z203b8",
    "colorBorderContainerTop": "--color-border-container-top-1itxac",
    "colorBorderControlChecked": "--color-border-control-checked-9uv01j",
    "colorBorderControlDefault": "--color-border-control-default-jt0hca",
    "colorBorderControlDisabled": "--color-border-control-disabled-zgidl5",
    "colorBorderDividerActive": "--color-border-divider-active-xsh3y8",
    "colorBorderDividerDefault": "--color-border-divider-default-k96bks",
    "colorBorderDividerPanelBottom": "--color-border-divider-panel-bottom-x6jr6g",
    "colorBorderDividerPanelSide": "--color-border-divider-panel-side-hxw8vd",
    "colorBorderDropdownContainer": "--color-border-dropdown-container-y6h1e1",
    "colorBorderDropdownGroup": "--color-border-dropdown-group-lane4t",
    "colorBorderDropdownItemDefault": "--color-border-dropdown-item-default-tcqivq",
    "colorBorderDropdownItemHover": "--color-border-dropdown-item-hover-d32f3f",
    "colorBorderDropdownItemDimmedHover": "--color-border-dropdown-item-dimmed-hover-znavol",
    "colorBorderDropdownItemSelected": "--color-border-dropdown-item-selected-bzuxys",
    "colorBorderDropdownItemTop": "--color-border-dropdown-item-top-3kvhpl",
    "colorBorderInputDefault": "--color-border-input-default-94d18j",
    "colorBorderInputDisabled": "--color-border-input-disabled-ek5o0x",
    "colorBorderItemFocused": "--color-border-item-focused-n5kd8g",
    "colorBorderItemPlaceholder": "--color-border-item-placeholder-wtgwev",
    "colorBorderItemSelected": "--color-border-item-selected-pr9yuf",
    "colorBorderLayout": "--color-border-layout-ifju5o",
    "colorBorderPopover": "--color-border-popover-jq2u63",
    "colorBorderSegmentActive": "--color-border-segment-active-9wobfw",
    "colorBorderSegmentDefault": "--color-border-segment-default-zm0agy",
    "colorBorderSegmentDisabled": "--color-border-segment-disabled-fqvszu",
    "colorBorderSegmentHover": "--color-border-segment-hover-0iwmji",
    "colorBorderStatusError": "--color-border-status-error-fybu9w",
    "colorBorderStatusInfo": "--color-border-status-info-0iedcr",
    "colorBorderStatusSuccess": "--color-border-status-success-lb896w",
    "colorBorderStatusWarning": "--color-border-status-warning-2otrg9",
    "colorBorderTabsDivider": "--color-border-tabs-divider-lf9ugx",
    "colorBorderTabsShadow": "--color-border-tabs-shadow-22eyu5",
    "colorBorderTabsUnderline": "--color-border-tabs-underline-ba6hzi",
    "colorBorderTilesDisabled": "--color-border-tiles-disabled-l8y8wj",
    "colorBorderTutorial": "--color-border-tutorial-9eqwas",
    "colorForegroundControlDefault": "--color-foreground-control-default-i2wjwi",
    "colorForegroundControlDisabled": "--color-foreground-control-disabled-84rf4t",
    "colorShadowDefault": "--color-shadow-default-94w2kz",
    "colorShadowMedium": "--color-shadow-medium-crhjfb",
    "colorShadowSide": "--color-shadow-side-gc6car",
    "colorStrokeCodeEditorResizeHandler": "--color-stroke-code-editor-resize-handler-j1za48",
    "colorStrokeCodeEditorGutterActiveLineDefault": "--color-stroke-code-editor-gutter-active-line-default-a8lwmo",
    "colorStrokeCodeEditorGutterActiveLineHover": "--color-stroke-code-editor-gutter-active-line-hover-uge7k0",
    "colorTextAccent": "--color-text-accent-s0earc",
    "colorTextBodyDefault": "--color-text-body-default-7m2b3r",
    "colorTextBodySecondary": "--color-text-body-secondary-u912t7",
    "colorTextBreadcrumbCurrent": "--color-text-breadcrumb-current-t6gbyx",
    "colorTextBreadcrumbIcon": "--color-text-breadcrumb-icon-wx9n5d",
    "colorTextButtonInlineIconDefault": "--color-text-button-inline-icon-default-qhj7jl",
    "colorTextButtonInlineIconDisabled": "--color-text-button-inline-icon-disabled-sesloi",
    "colorTextButtonInlineIconHover": "--color-text-button-inline-icon-hover-84mkuo",
    "colorTextButtonNormalActive": "--color-text-button-normal-active-hvhe2o",
    "colorTextButtonNormalDefault": "--color-text-button-normal-default-kwrutp",
    "colorTextButtonNormalHover": "--color-text-button-normal-hover-de4793",
    "colorTextLinkButtonNormalDefault": "--color-text-link-button-normal-default-4hy24d",
    "colorTextLinkButtonNormalHover": "--color-text-link-button-normal-hover-ir7bl3",
    "colorTextLinkButtonNormalActive": "--color-text-link-button-normal-active-1os5uu",
    "colorTextButtonPrimaryActive": "--color-text-button-primary-active-zvqo2f",
    "colorTextButtonPrimaryDefault": "--color-text-button-primary-default-iy7hsx",
    "colorTextButtonPrimaryHover": "--color-text-button-primary-hover-vtm3ow",
    "colorTextCalendarDayHover": "--color-text-calendar-day-hover-p7s945",
    "colorTextCalendarDaySelected": "--color-text-calendar-day-selected-fr68ny",
    "colorTextCalendarMonth": "--color-text-calendar-month-cx7jxx",
    "colorTextCodeEditorGutterActiveLine": "--color-text-code-editor-gutter-active-line-x8sbgu",
    "colorTextCodeEditorGutterDefault": "--color-text-code-editor-gutter-default-xo884c",
    "colorTextCodeEditorStatusBarDisabled": "--color-text-code-editor-status-bar-disabled-u2e9ms",
    "colorTextCodeEditorTabButtonError": "--color-text-code-editor-tab-button-error-r25g2o",
    "colorTextColumnHeader": "--color-text-column-header-nsvxtb",
    "colorTextColumnSortingIcon": "--color-text-column-sorting-icon-is8apt",
    "colorTextControlDisabled": "--color-text-control-disabled-l34dfo",
    "colorTextCounter": "--color-text-counter-wyou6g",
    "colorTextDisabled": "--color-text-disabled-pjiy51",
    "colorTextDropdownFooter": "--color-text-dropdown-footer-pjyuts",
    "colorTextDropdownGroupLabel": "--color-text-dropdown-group-label-45mv5a",
    "colorTextDropdownHeader": "--color-text-dropdown-header-j0w89b",
    "colorTextDropdownItemDefault": "--color-text-dropdown-item-default-ki8ao1",
    "colorTextDropdownItemDimmed": "--color-text-dropdown-item-dimmed-rjvzsf",
    "colorTextDropdownItemDisabled": "--color-text-dropdown-item-disabled-dgi2f4",
    "colorTextDropdownItemFilterMatch": "--color-text-dropdown-item-filter-match-4ejjcu",
    "colorTextDropdownItemHighlighted": "--color-text-dropdown-item-highlighted-90ve2t",
    "colorTextDropdownItemSecondary": "--color-text-dropdown-item-secondary-8hw5go",
    "colorTextEmpty": "--color-text-empty-izapdt",
    "colorTextExpandableSectionDefault": "--color-text-expandable-section-default-muap7v",
    "colorTextExpandableSectionHover": "--color-text-expandable-section-hover-fhlqd8",
    "colorTextExpandableSectionNavigationIconDefault": "--color-text-expandable-section-navigation-icon-default-xyvmb6",
    "colorTextFormDefault": "--color-text-form-default-ww6y8a",
    "colorTextFormLabel": "--color-text-form-label-i9s99a",
    "colorTextFormSecondary": "--color-text-form-secondary-1c3szk",
    "colorTextGroupLabel": "--color-text-group-label-5rxtyp",
    "colorTextHeadingDefault": "--color-text-heading-default-bjds33",
    "colorTextHeadingSecondary": "--color-text-heading-secondary-mvxtuw",
    "colorTextHomeHeaderDefault": "--color-text-home-header-default-wgdm5p",
    "colorTextHomeHeaderSecondary": "--color-text-home-header-secondary-g5rqe4",
    "colorTextIconCaret": "--color-text-icon-caret-geshd7",
    "colorTextIconSubtle": "--color-text-icon-subtle-1kz3jf",
    "colorTextInputDisabled": "--color-text-input-disabled-zfb02z",
    "colorTextInputPlaceholder": "--color-text-input-placeholder-rtvjp5",
    "colorTextInputPlaceholderDisabled": "--color-text-input-placeholder-disabled-60yf1a",
    "colorTextInteractiveActive": "--color-text-interactive-active-i5elzx",
    "colorTextInteractiveDefault": "--color-text-interactive-default-9me1cm",
    "colorTextInteractiveDisabled": "--color-text-interactive-disabled-jcikk2",
    "colorTextInteractiveHover": "--color-text-interactive-hover-79wpl9",
    "colorTextInteractiveInvertedDefault": "--color-text-interactive-inverted-default-toht84",
    "colorTextInteractiveInvertedHover": "--color-text-interactive-inverted-hover-nr6ig9",
    "colorTextInverted": "--color-text-inverted-p77o7g",
    "colorTextLabel": "--color-text-label-kjjshz",
    "colorTextLayoutToggle": "--color-text-layout-toggle-20sb9r",
    "colorTextLayoutToggleSelected": "--color-text-layout-toggle-selected-jquwag",
    "colorTextLinkDefault": "--color-text-link-default-753y4e",
    "colorTextLinkHover": "--color-text-link-hover-ok01xk",
    "colorTextLinkInvertedHover": "--color-text-link-inverted-hover-v9ehu7",
    "colorTextLinkButtonUnderline": "--color-text-link-button-underline-0wuqvw",
    "colorTextLinkButtonUnderlineHover": "--color-text-link-button-underline-hover-shj5w3",
    "colorTextLinkPrimaryUnderline": "--color-text-link-primary-underline-xq4vik",
    "colorTextNotificationDefault": "--color-text-notification-default-l83xtb",
    "colorTextPaginationPageNumberActiveDisabled": "--color-text-pagination-page-number-active-disabled-nidnvc",
    "colorTextPaginationPageNumberDefault": "--color-text-pagination-page-number-default-xf8q73",
    "colorTextSegmentActive": "--color-text-segment-active-o087le",
    "colorTextSegmentDefault": "--color-text-segment-default-9k644f",
    "colorTextSegmentHover": "--color-text-segment-hover-ez78pb",
    "colorTextSmall": "--color-text-small-5a9rs1",
    "colorTextStatusError": "--color-text-status-error-jer77f",
    "colorTextStatusInactive": "--color-text-status-inactive-2o9czw",
    "colorTextStatusInfo": "--color-text-status-info-09r23g",
    "colorTextStatusSuccess": "--color-text-status-success-hb5hdl",
    "colorTextStatusWarning": "--color-text-status-warning-94ezyx",
    "colorTextTopNavigationTitle": "--color-text-top-navigation-title-2nrlq4",
    "fontBodyMLineHeight": "--font-body-m-line-height-i7xxvv",
    "fontBodyMSize": "--font-body-m-size-sregvd",
    "fontBodySLetterSpacing": "--font-body-s-letter-spacing-p88gax",
    "fontBodySLineHeight": "--font-body-s-line-height-kdsbrl",
    "fontBodySSize": "--font-body-s-size-ukw2p9",
    "fontButtonLetterSpacing": "--font-button-letter-spacing-9fsbgj",
    "fontButtonWeight": "--font-button-weight-of7qcx",
    "fontChartDetailSize": "--font-chart-detail-size-viz5mm",
    "fontDisplayLLetterSpacing": "--font-display-l-letter-spacing-2u0pg2",
    "fontDisplayLLineHeight": "--font-display-l-line-height-gic9xn",
    "fontDisplayLSize": "--font-display-l-size-obs4uc",
    "fontDisplayLabelWeight": "--font-display-label-weight-tjy9e4",
    "fontExpandableHeadingSize": "--font-expandable-heading-size-6cp6jd",
    "fontFamilyBase": "--font-family-base-mylvzb",
    "fontFamilyMonospace": "--font-family-monospace-iz223z",
    "fontHeaderH2DescriptionLineHeight": "--font-header-h2-description-line-height-519y0m",
    "fontHeaderH2DescriptionSize": "--font-header-h2-description-size-q5s3cp",
    "fontHeadingLLetterSpacing": "--font-heading-l-letter-spacing-tthw81",
    "fontHeadingLLineHeight": "--font-heading-l-line-height-oujdab",
    "fontHeadingLSize": "--font-heading-l-size-glo9md",
    "fontHeadingLWeight": "--font-heading-l-weight-qh3c9t",
    "fontHeadingMLetterSpacing": "--font-heading-m-letter-spacing-vsl82f",
    "fontHeadingMLineHeight": "--font-heading-m-line-height-wqj6lz",
    "fontHeadingMSize": "--font-heading-m-size-f8kmgg",
    "fontHeadingMWeight": "--font-heading-m-weight-0y5yq5",
    "fontHeadingSLetterSpacing": "--font-heading-s-letter-spacing-i014lh",
    "fontHeadingSLineHeight": "--font-heading-s-line-height-5b7f0q",
    "fontHeadingSSize": "--font-heading-s-size-9clg8y",
    "fontHeadingSWeight": "--font-heading-s-weight-1ygwuy",
    "fontHeadingXlLetterSpacing": "--font-heading-xl-letter-spacing-v5jzbn",
    "fontHeadingXlLineHeight": "--font-heading-xl-line-height-qeciux",
    "fontHeadingXlSize": "--font-heading-xl-size-etf0gx",
    "fontHeadingXlWeight": "--font-heading-xl-weight-zuv5k6",
    "fontHeadingXsLineHeight": "--font-heading-xs-line-height-tf278d",
    "fontHeadingXsSize": "--font-heading-xs-size-j82aha",
    "fontHeadingXsWeight": "--font-heading-xs-weight-5hfvig",
    "fontBoxValueLargeWeight": "--font-box-value-large-weight-eliigm",
    "fontLinkButtonLetterSpacing": "--font-link-button-letter-spacing-7hbib6",
    "fontLinkButtonWeight": "--font-link-button-weight-g5p0bg",
    "fontLinkPrimaryDecoration": "--font-link-primary-decoration-yl9l62",
    "fontLinkPrimaryLetterSpacing": "--font-link-primary-letter-spacing-4lvjol",
    "fontLinkPrimaryWeight": "--font-link-primary-weight-08ec3r",
    "fontPanelHeaderLineHeight": "--font-panel-header-line-height-dwnc1y",
    "fontPanelHeaderSize": "--font-panel-header-size-s14y0f",
    "fontTabsDisabledWeight": "--font-tabs-disabled-weight-0s5m6k",
    "fontTabsLineHeight": "--font-tabs-line-height-7pfmod",
    "fontTabsSize": "--font-tabs-size-nwweud",
    "fontWayfindingLinkActiveWeight": "--font-wayfinding-link-active-weight-r40wpo",
    "fontWeightHeavy": "--font-weight-heavy-2y7wni",
    "borderActiveWidth": "--border-active-width-bo43mb",
    "borderCodeEditorStatusDividerWidth": "--border-code-editor-status-divider-width-bgledl",
    "borderContainerStickyWidth": "--border-container-sticky-width-pybmba",
    "borderContainerTopWidth": "--border-container-top-width-fs2udu",
    "borderControlFocusRingShadowSpread": "--border-control-focus-ring-shadow-spread-glnuoy",
    "borderControlInvalidFocusRingShadowSpread": "--border-control-invalid-focus-ring-shadow-spread-6t5p47",
    "borderDividerListWidth": "--border-divider-list-width-hacikr",
    "borderDividerSectionWidth": "--border-divider-section-width-5a4cv1",
    "borderDropdownVirtualOffsetWidth": "--border-dropdown-virtual-offset-width-4yuah4",
    "borderFieldWidth": "--border-field-width-y6x4sn",
    "borderInvalidWidth": "--border-invalid-width-glmng5",
    "borderItemWidth": "--border-item-width-yvnixs",
    "borderLineChartDashArray": "--border-line-chart-dash-array-4wa4ab",
    "borderLineChartLineJoin": "--border-line-chart-line-join-zprv4i",
    "borderLineChartWidth": "--border-line-chart-width-nj0hc5",
    "borderPanelHeaderWidth": "--border-panel-header-width-ebtw6k",
    "borderPanelTopWidth": "--border-panel-top-width-uf27ee",
    "borderRadiusAlert": "--border-radius-alert-rd1nuz",
    "borderRadiusBadge": "--border-radius-badge-la3wqa",
    "borderRadiusButton": "--border-radius-button-qh52qv",
    "borderRadiusCalendarDayFocusRing": "--border-radius-calendar-day-focus-ring-16ha5s",
    "borderRadiusCodeEditor": "--border-radius-code-editor-7hgl06",
    "borderRadiusContainer": "--border-radius-container-1aveko",
    "borderRadiusControlCircularFocusRing": "--border-radius-control-circular-focus-ring-l88ib6",
    "borderRadiusControlDefaultFocusRing": "--border-radius-control-default-focus-ring-hekmgc",
    "borderRadiusDropdown": "--border-radius-dropdown-0c284d",
    "borderRadiusFlashbar": "--border-radius-flashbar-hhymq3",
    "borderRadiusItem": "--border-radius-item-wjpc1f",
    "borderRadiusInput": "--border-radius-input-fterib",
    "borderRadiusPopover": "--border-radius-popover-5z2f35",
    "borderRadiusTabsFocusRing": "--border-radius-tabs-focus-ring-774qv9",
    "borderRadiusTiles": "--border-radius-tiles-3ylknk",
    "borderRadiusToken": "--border-radius-token-3ax3p2",
    "borderRadiusTutorialPanelItem": "--border-radius-tutorial-panel-item-nnx1b4",
    "borderTableStickyWidth": "--border-table-sticky-width-52djt5",
    "borderLinkFocusRingOutline": "--border-link-focus-ring-outline-67z0xv",
    "borderLinkFocusRingShadowSpread": "--border-link-focus-ring-shadow-spread-e3dct9",
    ...
    "motionEasingResponsive": "--motion-easing-responsive-rdey2s",
    "motionEasingSticky": "--motion-easing-sticky-ckeqjc",
    "motionEasingExpressive": "--motion-easing-expressive-f6j6f5",
    "motionDurationResponsive": "--motion-duration-responsive-6gesm2",
    "motionDurationExpressive": "--motion-duration-expressive-7zlqxq",
    "motionDurationComplex": "--motion-duration-complex-0dbuo2",
    "motionKeyframesFadeIn": "--motion-keyframes-fade-in-9ud20b",
    "motionKeyframesFadeOut": "--motion-keyframes-fade-out-1ayoyt",
    "motionKeyframesStatusIconError": "--motion-keyframes-status-icon-error-z7c2ei",
    "motionKeyframesScalePopup": "--motion-keyframes-scale-popup-djpph0",
    "sizeCalendarGridWidth": "--size-calendar-grid-width-luenzs",
    "sizeControl": "--size-control-eyly4k",
    "sizeIconBig": "--size-icon-big-cu55wt",
    "sizeIconLarge": "--size-icon-large-9vh494",
    "sizeIconMedium": "--size-icon-medium-yynucr",
    "sizeIconNormal": "--size-icon-normal-j1z5fn",
    "sizeVerticalInput": "--size-vertical-input-ikahdk",
    "sizeVerticalPanelIconOffset": "--size-vertical-panel-icon-offset-ti40n4",
    "spaceAlertActionLeft": "--space-alert-action-left-ovi85g",
    "spaceAlertHorizontal": "--space-alert-horizontal-dvwbh6",
    "spaceAlertMessageRight": "--space-alert-message-right-tj2fce",
    "spaceAlertVertical": "--space-alert-vertical-u5mo8e",
    "spaceButtonFocusOutlineGutter": "--space-button-focus-outline-gutter-znvbd3",
    "spaceButtonIconFocusOutlineGutterVertical": "--space-button-icon-focus-outline-gutter-vertical-193bnu",
    "spaceButtonIconOnlyHorizontal": "--space-button-icon-only-horizontal-xty1oa",
    "spaceButtonInlineIconFocusOutlineGutter": "--space-button-inline-icon-focus-outline-gutter-gevzfn",
    "spaceButtonModalDismissVertical": "--space-button-modal-dismiss-vertical-zj7c79",
    "spaceCalendarGridFocusOutlineGutter": "--space-calendar-grid-focus-outline-gutter-lbmex4",
    "spaceCalendarGridSelectedFocusOutlineGutter": "--space-calendar-grid-selected-focus-outline-gutter-s5ollf",
    "spaceCardHorizontal": "--space-card-horizontal-di7llb",
    "spaceCodeEditorStatusFocusOutlineGutter": "--space-code-editor-status-focus-outline-gutter-hxg2um",
    "spaceContainerContentTop": "--space-container-content-top-u412x3",
    "spaceContainerHeaderVertical": "--space-container-header-vertical-0bd19u",
    "spaceContainerHorizontal": "--space-container-horizontal-tlw03i",
    "spaceDarkHeaderPaddingBottom": "--space-dark-header-padding-bottom-v95akv",
    "spaceDarkHeaderOverlapDistance": "--space-dark-header-overlap-distance-ync2s3",
    "spaceExpandableSectionIconOffsetTop": "--space-expandable-section-icon-offset-top-jo3eu8",
    "spaceFieldHorizontal": "--space-field-horizontal-z3i1c8",
    "spaceFieldIconOffset": "--space-field-icon-offset-alfd6o",
    "spaceFilteringTokenDismissButtonFocusOutlineGutter": "--space-filtering-token-dismiss-button-focus-outline-gutter-25v038",
    "spaceFilteringTokenOperationSelectFocusOutlineGutter": "--space-filtering-token-operation-select-focus-outline-gutter-0nruvp",
    "spaceFlashbarActionLeft": "--space-flashbar-action-left-rq23at",
    "spaceFlashbarDismissRight": "--space-flashbar-dismiss-right-tlepp9",
    "spaceFlashbarHorizontal": "--space-flashbar-horizontal-klv28o",
    "spaceGridGutter": "--space-grid-gutter-0subky",
    "spaceLayoutContentBottom": "--space-layout-content-bottom-ebez2l",
    "spaceLayoutToggleDiameter": "--space-layout-toggle-diameter-hzvqtj",
    "spaceLayoutTogglePadding": "--space-layout-toggle-padding-axl9jr",
    "spaceModalContentBottom": "--space-modal-content-bottom-2tkcs5",
    "spaceModalHorizontal": "--space-modal-horizontal-ah0xld",
    "spacePanelNavLeft": "--space-panel-nav-left-hwf0ky",
    "spacePanelSideLeft": "--space-panel-side-left-o3fm3s",
    "spacePanelSideRight": "--space-panel-side-right-oktwq8",
    "spacePanelSplitTop": "--space-panel-split-top-mpmkyz",
    "spaceSegmentedControlFocusOutlineGutter": "--space-segmented-control-focus-outline-gutter-82bijn",
    "spaceTableHeaderFocusOutlineGutter": "--space-table-header-focus-outline-gutter-uqywlq",
    "spaceTabsContentTop": "--space-tabs-content-top-5xrhx5",
    "spaceTableHorizontal": "--space-table-horizontal-njdbej",
    "spaceTableHeaderHorizontal": "--space-table-header-horizontal-4u689g",
    "spaceTableContentBottom": "--space-table-content-bottom-2l75ve",
    "spaceTableContentTop": "--space-table-content-top-su9ka6",
    "spaceTableEmbeddedContentBottom": "--space-table-embedded-content-bottom-7vc5vt",
    "spaceTableEmbeddedHeaderTop": "--space-table-embedded-header-top-1yxc8d",
    "spaceTableFooterHorizontal": "--space-table-footer-horizontal-m6qo87",
    "spaceTabsFocusOutlineGutter": "--space-tabs-focus-outline-gutter-th1z8v",
    "spaceTextGridVertical": "--space-text-grid-vertical-9z9zv2",
    "spaceScaled2xNone": "--space-scaled-2x-none-j0dnbr",
    "spaceScaled2xXxxs": "--space-scaled-2x-xxxs-dhhb3b",
    "spaceScaled2xXxs": "--space-scaled-2x-xxs-t5qzmf",
    "spaceScaled2xXs": "--space-scaled-2x-xs-14s0ux",
    ...
    "spaceScaledNone": "--space-scaled-none-cnv7sd",
    "spaceScaledXxxs": "--space-scaled-xxxs-b6dm8t",
    ...
    "shadowContainer": "--shadow-container-0bkp96",
    "shadowContainerStacked": "--shadow-container-stacked-j8j87i",
    "shadowDropdown": "--shadow-dropdown-lzmmvx",
    "shadowDropup": "--shadow-dropup-zo6vd9",
    "shadowFlashSticky": "--shadow-flash-sticky-4fgfqg",
    "shadowModal": "--shadow-modal-ukglr0",
    "shadowPanel": "--shadow-panel-v9vx7i",
    "shadowPanelToggle": "--shadow-panel-toggle-ufvynr",
    "shadowPopover": "--shadow-popover-r85x77",
    "shadowSplitBottom": "--shadow-split-bottom-nxe040",
    "shadowSplitSide": "--shadow-split-side-dzdo00",
    "shadowSticky": "--shadow-sticky-thyisb",
    "shadowStickyEmbedded": "--shadow-sticky-embedded-5acv0s"
  }
};

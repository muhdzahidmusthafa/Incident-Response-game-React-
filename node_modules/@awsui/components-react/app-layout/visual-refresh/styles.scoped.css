...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
section.awsui_appbar_hyvsj_homer_93:not(#\9) {
  align-items: center;
...
section.awsui_appbar_hyvsj_homer_93 > .awsui_appbar-nav_hyvsj_homer_117:not(#\9) {
  grid-column: 1;
  margin-right: var(--space-m-17eucw, 16px);
}
section.awsui_appbar_hyvsj_homer_93 > .awsui_breadcrumbs_hyvsj_homer_121:not(#\9) {
  grid-column: 2;
  background-color: var(--color-background-layout-main-q0tbxx, #f2f3f3);
}
section.awsui_appbar_hyvsj_homer_93 > .awsui_appbar-tools_hyvsj_homer_125:not(#\9) {
  grid-column: 3;
...
@media (min-width: 689px) {
  ...
  section.awsui_appbar_hyvsj_homer_93:not(#\9):not(.awsui_has-breadcrumbs_hyvsj_homer_160) {
    display: none;
  }
  section.awsui_appbar_hyvsj_homer_93 > .awsui_appbar-nav_hyvsj_homer_117:not(#\9),
section.awsui_appbar_hyvsj_homer_93 > .awsui_appbar-tools_hyvsj_homer_125:not(#\9) {
  ...
  section.awsui_appbar_hyvsj_homer_93 > .awsui_breadcrumbs_hyvsj_homer_121:not(#\9):not(.awsui_has-notifications-content_hyvsj_homer_167) {
    padding-top: var(--space-scaled-m-pv0fmt, 16px);
  }
  section.awsui_appbar_hyvsj_homer_93 > .awsui_breadcrumbs_hyvsj_homer_121.awsui_has-notifications-content_hyvsj_homer_167:not(#\9) {
    padding-top: var(--space-scaled-2x-s-9svxjy, 12px);
  }
  section.awsui_appbar_hyvsj_homer_93 > .awsui_breadcrumbs_hyvsj_homer_121:not(#\9):not(.awsui_has-header_hyvsj_homer_173):not(.awsui_has-dynamic-overlap-height_hyvsj_homer_173),
section.awsui_appbar_hyvsj_homer_93 > .awsui_breadcrumbs_hyvsj_homer_121:not(#\9):not(.awsui_has-header_hyvsj_homer_173).awsui_content-type-wizard_hyvsj_homer_174 {
    padding-bottom: var(--space-m-17eucw, 16px);
  }
  section.awsui_appbar_hyvsj_homer_93 > .awsui_breadcrumbs_hyvsj_homer_121.awsui_content-type-cards_hyvsj_homer_177:not(#\9),
section.awsui_appbar_hyvsj_homer_93 > .awsui_breadcrumbs_hyvsj_homer_121.awsui_content-type-table_hyvsj_homer_178:not(#\9) {
...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
div.awsui_background_hyvsj_homer_213:not(#\9) {
  display: contents;
}
div.awsui_background_hyvsj_homer_213 > .awsui_notifications-appbar-header_hyvsj_homer_216:not(#\9) {
  background-color: var(--color-background-layout-main-q0tbxx, #f2f3f3);
  grid-column: 1/span 5;
  grid-row: 1/span 3;
  /*
...
@media (min-width: 689px) {
  div.awsui_background_hyvsj_homer_213 > .awsui_notifications-appbar-header_hyvsj_homer_216.awsui_content-type-cards_hyvsj_homer_177.awsui_has-notifications-content_hyvsj_homer_167.awsui_sticky-notifications_hyvsj_homer_228:not(#\9), div.awsui_background_hyvsj_homer_213 > .awsui_notifications-appbar-header_hyvsj_homer_216.awsui_content-type-table_hyvsj_homer_178.awsui_has-notifications-content_hyvsj_homer_167.awsui_sticky-notifications_hyvsj_homer_228:not(#\9) {
    position: sticky;
    top: var(--awsui-offset-top-ujkcpl);
    z-index: 799;
  }
}
div.awsui_background_hyvsj_homer_213 > .awsui_overlap_hyvsj_homer_234:not(#\9) {
  background-color: var(--color-background-layout-main-q0tbxx, #f2f3f3);
  grid-column: 1/span 5;
  grid-row: 4;
  /*
...
@media (min-width: 689px) {
  div.awsui_background_hyvsj_homer_213 > .awsui_overlap_hyvsj_homer_234.awsui_content-type-cards_hyvsj_homer_177:not(#\9), div.awsui_background_hyvsj_homer_213 > .awsui_overlap_hyvsj_homer_234.awsui_content-type-table_hyvsj_homer_178:not(#\9) {
    position: sticky;
...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
header.awsui_content_hyvsj_homer_174:not(#\9) {
  grid-column: 3;
  grid-row: 3;
...
@media (min-width: 689px) {
  ...
  header.awsui_content_hyvsj_homer_174.awsui_has-notifications-content_hyvsj_homer_167:not(#\9):not(.awsui_has-breadcrumbs_hyvsj_homer_160) {
    padding-top: var(--space-scaled-xs-6859qs, 8px);
  }
  header.awsui_content_hyvsj_homer_174.awsui_has-breadcrumbs_hyvsj_homer_160:not(#\9) {
    padding-top: var(--space-xxs-ynfts5, 4px);
  }
  header.awsui_content_hyvsj_homer_174:not(#\9):not(.awsui_has-notifications-content_hyvsj_homer_167):not(.awsui_has-breadcrumbs_hyvsj_homer_160) {
    padding-top: var(--space-scaled-xs-6859qs, 8px);
  }
}
@media (max-width: 688px) {
  ...
  header.awsui_content_hyvsj_homer_174.awsui_has-notifications-content_hyvsj_homer_167:not(#\9) {
    padding-top: var(--space-scaled-xs-6859qs, 8px);
  }
}
...
/*
  ...
  */
.awsui_layout_hyvsj_homer_322:not(#\9) {
...
@media (min-width: 1401px) {
  .awsui_layout_hyvsj_homer_322:not(#\9):not(.awsui_has-max-content-width_hyvsj_homer_404) {
    --awsui-default-max-content-width-ujkcpl: 1280px;
  }
}
...
.awsui_layout_hyvsj_homer_322.awsui_has-max-content-width_hyvsj_homer_404:not(#\9) {
...
.awsui_layout_hyvsj_homer_322.awsui_is-overlap-disabled_hyvsj_homer_431:not(#\9) {
  --awsui-overlap-height-ujkcpl: 0;
}
.awsui_layout_hyvsj_homer_322:not(#\9):not(.awsui_disable-body-scroll_hyvsj_homer_434) {
  --awsui-offset-top-ujkcpl: var(--awsui-header-height-ujkcpl);
  min-height: var(--awsui-content-height-ujkcpl);
}
.awsui_layout_hyvsj_homer_322:not(#\9):not(.awsui_disable-body-scroll_hyvsj_homer_434):not(.awsui_has-sticky-notifications_hyvsj_homer_438) {
  --awsui-offset-top-with-notifications-ujkcpl: var(--awsui-header-height-ujkcpl);
}
.awsui_layout_hyvsj_homer_322:not(#\9):not(.awsui_disable-body-scroll_hyvsj_homer_434).awsui_has-sticky-notifications_hyvsj_homer_438 {
...
.awsui_layout_hyvsj_homer_322.awsui_disable-body-scroll_hyvsj_homer_434:not(#\9) {
  --awsui-offset-top-ujkcpl: 0px;
  grid-template-rows: repeat(3, auto) var(--awsui-overlap-height-ujkcpl) 1fr auto;
  height: var(--awsui-content-height-ujkcpl);
  overflow-y: scroll;
}
.awsui_layout_hyvsj_homer_322.awsui_disable-body-scroll_hyvsj_homer_434.awsui_has-split-panel_hyvsj_homer_452.awsui_split-panel-position-bottom_hyvsj_homer_452:not(#\9) {
  grid-template-rows: repeat(3, auto) var(--awsui-overlap-height-ujkcpl) repeat(2, auto);
}
.awsui_layout_hyvsj_homer_322.awsui_disable-body-scroll_hyvsj_homer_434:not(#\9):not(.awsui_has-sticky-notifications_hyvsj_homer_438) {
  --awsui-offset-top-with-notifications-ujkcpl: 0px;
}
.awsui_layout_hyvsj_homer_322.awsui_disable-body-scroll_hyvsj_homer_434.awsui_has-sticky-notifications_hyvsj_homer_438:not(#\9) {
  --awsui-offset-top-with-notifications-ujkcpl: calc(
      var(--awsui-notifications-height-ujkcpl) + var(--space-xs-rsr2qu, 8px) + var(--space-xxs-ynfts5, 4px)
    );
}
@media (min-width: 689px) {
  .awsui_layout_hyvsj_homer_322.awsui_has-content-gap-left_hyvsj_homer_464:not(#\9) {
    --awsui-content-gap-left-ujkcpl: var(--space-scaled-2x-xxxl-lbp35j, 40px);
  }
  .awsui_layout_hyvsj_homer_322.awsui_has-content-gap-right_hyvsj_homer_467:not(#\9) {
...
*/
.awsui_block-body-scroll_hyvsj_homer_482:not(#\9) {
  overflow: hidden;
}
...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
.awsui_container_hyvsj_homer_490:not(#\9) {
  grid-column: 3;
  grid-row: 4/span 2;
...
.awsui_container_hyvsj_homer_490.awsui_disable-content-paddings_hyvsj_homer_507:not(#\9) {
  grid-column: 1/6;
  padding: 0;
}
@media (min-width: 689px) {
  .awsui_container_hyvsj_homer_490.awsui_disable-content-paddings_hyvsj_homer_507.awsui_is-navigation-open_hyvsj_homer_512:not(#\9) {
    grid-column-start: 2;
  }
  .awsui_container_hyvsj_homer_490.awsui_disable-content-paddings_hyvsj_homer_507.awsui_is-tools-open_hyvsj_homer_515:not(#\9), .awsui_container_hyvsj_homer_490.awsui_disable-content-paddings_hyvsj_homer_507.awsui_is-split-panel-open_hyvsj_homer_515.awsui_split-panel-position-side_hyvsj_homer_515:not(#\9) {
    grid-column-end: 5;
  }
}
@media (min-width: 689px) {
  .awsui_container_hyvsj_homer_490:not(#\9):not(.awsui_disable-content-paddings_hyvsj_homer_507) {
    /*
  ...
  .awsui_container_hyvsj_homer_490:not(#\9):not(.awsui_disable-content-paddings_hyvsj_homer_507).awsui_content-type-default_hyvsj_homer_535.awsui_has-notifications-content_hyvsj_homer_167:not(.awsui_has-breadcrumbs_hyvsj_homer_160):not(.awsui_has-header_hyvsj_homer_173):not(.awsui_has-dynamic-overlap-height_hyvsj_homer_173), .awsui_container_hyvsj_homer_490:not(#\9):not(.awsui_disable-content-paddings_hyvsj_homer_507).awsui_content-type-form_hyvsj_homer_535.awsui_has-notifications-content_hyvsj_homer_167:not(.awsui_has-breadcrumbs_hyvsj_homer_160):not(.awsui_has-header_hyvsj_homer_173):not(.awsui_has-dynamic-overlap-height_hyvsj_homer_173) {
    padding-top: var(--space-scaled-m-pv0fmt, 16px);
  }
  .awsui_container_hyvsj_homer_490:not(#\9):not(.awsui_disable-content-paddings_hyvsj_homer_507).awsui_content-type-default_hyvsj_homer_535:not(.awsui_has-notifications-content_hyvsj_homer_167):not(.awsui_has-breadcrumbs_hyvsj_homer_160):not(.awsui_has-header_hyvsj_homer_173):not(.awsui_has-dynamic-overlap-height_hyvsj_homer_173), .awsui_container_hyvsj_homer_490:not(#\9):not(.awsui_disable-content-paddings_hyvsj_homer_507).awsui_content-type-form_hyvsj_homer_535:not(.awsui_has-notifications-content_hyvsj_homer_167):not(.awsui_has-breadcrumbs_hyvsj_homer_160):not(.awsui_has-header_hyvsj_homer_173):not(.awsui_has-dynamic-overlap-height_hyvsj_homer_173) {
    padding-top: var(--space-scaled-xs-6859qs, 8px);
  }
  .awsui_container_hyvsj_homer_490:not(#\9):not(.awsui_disable-content-paddings_hyvsj_homer_507).awsui_has-header_hyvsj_homer_173, .awsui_container_hyvsj_homer_490:not(#\9):not(.awsui_disable-content-paddings_hyvsj_homer_507).awsui_has-dynamic-overlap-height_hyvsj_homer_173 {
    padding-top: 0;
  }
}
@media (max-width: 688px) {
  ...
  .awsui_container_hyvsj_homer_490:not(#\9):not(.awsui_disable-content-paddings_hyvsj_homer_507).awsui_content-type-default_hyvsj_homer_535.awsui_has-notifications-content_hyvsj_homer_167:not(.awsui_has-header_hyvsj_homer_173):not(.awsui_has-dynamic-overlap-height_hyvsj_homer_173), .awsui_container_hyvsj_homer_490:not(#\9):not(.awsui_disable-content-paddings_hyvsj_homer_507).awsui_content-type-form_hyvsj_homer_535.awsui_has-notifications-content_hyvsj_homer_167:not(.awsui_has-header_hyvsj_homer_173):not(.awsui_has-dynamic-overlap-height_hyvsj_homer_173) {
    padding-top: var(--space-scaled-m-pv0fmt, 16px);
  }
  .awsui_container_hyvsj_homer_490:not(#\9):not(.awsui_disable-content-paddings_hyvsj_homer_507).awsui_content-type-default_hyvsj_homer_535:not(.awsui_has-notifications-content_hyvsj_homer_167):not(.awsui_has-header_hyvsj_homer_173):not(.awsui_has-dynamic-overlap-height_hyvsj_homer_173), .awsui_container_hyvsj_homer_490:not(#\9):not(.awsui_disable-content-paddings_hyvsj_homer_507).awsui_content-type-form_hyvsj_homer_535:not(.awsui_has-notifications-content_hyvsj_homer_167):not(.awsui_has-header_hyvsj_homer_173):not(.awsui_has-dynamic-overlap-height_hyvsj_homer_173) {
    padding-top: var(--space-scaled-m-pv0fmt, 16px);
  }
  .awsui_container_hyvsj_homer_490:not(#\9):not(.awsui_disable-content-paddings_hyvsj_homer_507).awsui_has-header_hyvsj_homer_173, .awsui_container_hyvsj_homer_490:not(#\9):not(.awsui_disable-content-paddings_hyvsj_homer_507).awsui_has-dynamic-overlap-height_hyvsj_homer_173 {
    padding-top: 0;
...
.awsui_container_hyvsj_homer_490.awsui_content-type-cards_hyvsj_homer_177:not(#\9), .awsui_container_hyvsj_homer_490.awsui_content-type-table_hyvsj_homer_178:not(#\9), .awsui_container_hyvsj_homer_490.awsui_content-type-wizard_hyvsj_homer_174:not(#\9) {
  padding-top: 0;
}

/* stylelint-disable-next-line selector-combinator-disallowed-list, selector-max-universal */
.awsui_unfocusable_hyvsj_homer_576 *:not(#\9) {
...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
.awsui_navigation-container_hyvsj_homer_584:not(#\9) {
...
nav.awsui_show-navigation_hyvsj_homer_608:not(#\9) {
...
@keyframes awsui_showButtons_hyvsj_homer_1 {
  0% {
    opacity: 0;
  }
  100% {
...
nav.awsui_show-navigation_hyvsj_homer_608.awsui_is-navigation-open_hyvsj_homer_512:not(#\9) {
  display: none;
}
@media (min-width: 689px) {
  nav.awsui_show-navigation_hyvsj_homer_608:not(#\9):not(.awsui_is-navigation-open_hyvsj_homer_512) {
    display: block;
  }
  nav.awsui_show-navigation_hyvsj_homer_608:not(#\9):not(.awsui_is-navigation-open_hyvsj_homer_512).awsui_animating_hyvsj_homer_630 {
    animation: awsui_showButtons_hyvsj_homer_1 var(--motion-duration-refresh-only-fast-addxjd, 115ms);
  }
}
...
@media (min-width: 689px) {
  .awsui-motion-disabled nav.awsui_show-navigation_hyvsj_homer_608:not(#\9):not(.awsui_is-navigation-open_hyvsj_homer_512).awsui_animating_hyvsj_homer_630, .awsui-mode-entering nav.awsui_show-navigation_hyvsj_homer_608:not(#\9):not(.awsui_is-navigation-open_hyvsj_homer_512).awsui_animating_hyvsj_homer_630 {
    animation: none;
    transition: none;
  }
}

nav.awsui_navigation_hyvsj_homer_584:not(#\9) {
...
@keyframes awsui_openNavigation_hyvsj_homer_1 {
  from {
    opacity: 0;
...
nav.awsui_navigation_hyvsj_homer_584:not(#\9):not(.awsui_is-navigation-open_hyvsj_homer_512) {
  width: 0;
  display: none;
}
nav.awsui_navigation_hyvsj_homer_584.awsui_is-navigation-open_hyvsj_homer_512.awsui_animating_hyvsj_homer_630:not(#\9) {
  animation: awsui_openNavigation_hyvsj_homer_1 var(--motion-duration-refresh-only-fast-addxjd, 115ms);
}
...
.awsui-motion-disabled nav.awsui_navigation_hyvsj_homer_584.awsui_is-navigation-open_hyvsj_homer_512.awsui_animating_hyvsj_homer_630:not(#\9), .awsui-mode-entering nav.awsui_navigation_hyvsj_homer_584.awsui_is-navigation-open_hyvsj_homer_512.awsui_animating_hyvsj_homer_630:not(#\9) {
  animation: none;
  transition: none;
}
nav.awsui_navigation_hyvsj_homer_584 > .awsui_animated-content_hyvsj_homer_690:not(#\9) {
  width: var(--awsui-navigation-width-ujkcpl);
}
@media (max-width: 688px) {
  nav.awsui_navigation_hyvsj_homer_584:not(#\9) {
...
.awsui_hide-navigation_hyvsj_homer_699:not(#\9) {
  position: absolute;
...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
.awsui_notifications_hyvsj_homer_216:not(#\9) {
  grid-column: 3;
  grid-row: 1;
  z-index: 825;
  /*
...
@media (min-width: 689px) {
  ...
  .awsui_notifications_hyvsj_homer_216.awsui_sticky-notifications_hyvsj_homer_228:not(#\9) {
    position: sticky;
    top: calc(var(--awsui-offset-top-ujkcpl) + var(--space-xs-rsr2qu, 8px));
  }
  .awsui_notifications_hyvsj_homer_216:not(#\9):not(.awsui_has-notifications-content_hyvsj_homer_167) {
    margin: 0;
  }
}
@media (max-width: 688px) {
...
parent height.
*/
section.awsui_split-panel-bottom_hyvsj_homer_766:not(#\9) {
...
@keyframes awsui_openSplitPanelBottom_hyvsj_homer_1 {
  from {
...
section.awsui_split-panel-bottom_hyvsj_homer_766.awsui_disable-body-scroll_hyvsj_homer_434:not(#\9) {
  bottom: 0;
}
section.awsui_split-panel-bottom_hyvsj_homer_766.awsui_is-navigation-open_hyvsj_homer_512.awsui_position-bottom_hyvsj_homer_801:not(#\9) {
  grid-column-start: 2;
}
section.awsui_split-panel-bottom_hyvsj_homer_766.awsui_is-tools-open_hyvsj_homer_515.awsui_position-bottom_hyvsj_homer_801:not(#\9) {
  grid-column-end: 5;
}
section.awsui_split-panel-bottom_hyvsj_homer_766.awsui_position-bottom_hyvsj_homer_801:not(#\9) {
  display: block;
}
section.awsui_split-panel-bottom_hyvsj_homer_766:not(#\9):not(.awsui_is-split-panel-open_hyvsj_homer_515).awsui_position-bottom_hyvsj_homer_801 {
  box-shadow: rgba(0, 7, 22, 0.1) 0px -32px 32px -24px;
}
section.awsui_split-panel-bottom_hyvsj_homer_766.awsui_is-split-panel-open_hyvsj_homer_515.awsui_position-bottom_hyvsj_homer_801:not(#\9) {
  box-shadow: var(--shadow-split-bottom-nxe040, 0 -2px 1px -1px rgba(0, 28, 36, 0.15), 0 -1px 1px -1px rgba(0, 28, 36, 0.3));
}
section.awsui_split-panel-bottom_hyvsj_homer_766.awsui_is-split-panel-open_hyvsj_homer_515.awsui_position-bottom_hyvsj_homer_801.awsui_animating_hyvsj_homer_630:not(#\9) {
  animation: awsui_openSplitPanelBottom_hyvsj_homer_1 var(--motion-duration-refresh-only-fast-addxjd, 115ms);
}
@media (prefers-reduced-motion: reduce) {
  section.awsui_split-panel-bottom_hyvsj_homer_766.awsui_is-split-panel-open_hyvsj_homer_515.awsui_position-bottom_hyvsj_homer_801.awsui_animating_hyvsj_homer_630:not(#\9) {
    animation: none;
...
.awsui-motion-disabled section.awsui_split-panel-bottom_hyvsj_homer_766.awsui_is-split-panel-open_hyvsj_homer_515.awsui_position-bottom_hyvsj_homer_801.awsui_animating_hyvsj_homer_630:not(#\9), .awsui-mode-entering section.awsui_split-panel-bottom_hyvsj_homer_766.awsui_is-split-panel-open_hyvsj_homer_515.awsui_position-bottom_hyvsj_homer_801.awsui_animating_hyvsj_homer_630:not(#\9) {
  animation: none;
  transition: none;
}

section.awsui_split-panel-side_hyvsj_homer_830:not(#\9) {
  height: 100%;
  overflow-x: hidden;
  /*
...
@keyframes awsui_openSplitPanelSide_hyvsj_homer_1 {
  from {
    opacity: 0;
...
section.awsui_split-panel-side_hyvsj_homer_830:not(#\9):not(.awsui_is-split-panel-open_hyvsj_homer_515), section.awsui_split-panel-side_hyvsj_homer_830.awsui_position-bottom_hyvsj_homer_801:not(#\9) {
  width: 0;
}
section.awsui_split-panel-side_hyvsj_homer_830.awsui_is-split-panel-open_hyvsj_homer_515.awsui_position-side_hyvsj_homer_857:not(#\9) {
  box-shadow: var(--shadow-panel-v9vx7i, 0 1px 1px 0 rgba(0, 28, 36, 0.3), 1px 1px 1px 0 rgba(0, 28, 36, 0.15), -1px 1px 1px 0 rgba(0, 28, 36, 0.15));
  max-width: var(--awsui-split-panel-max-width-ujkcpl, 280px);
  min-width: var(--awsui-split-panel-min-width-ujkcpl, 280px);
}
section.awsui_split-panel-side_hyvsj_homer_830.awsui_is-split-panel-open_hyvsj_homer_515.awsui_position-side_hyvsj_homer_857.awsui_animating_hyvsj_homer_630:not(#\9) {
  animation: awsui_openSplitPanelSide_hyvsj_homer_1 var(--motion-duration-refresh-only-fast-addxjd, 115ms);
}
@media (prefers-reduced-motion: reduce) {
  section.awsui_split-panel-side_hyvsj_homer_830.awsui_is-split-panel-open_hyvsj_homer_515.awsui_position-side_hyvsj_homer_857.awsui_animating_hyvsj_homer_630:not(#\9) {
    animation: none;
...
.awsui-motion-disabled section.awsui_split-panel-side_hyvsj_homer_830.awsui_is-split-panel-open_hyvsj_homer_515.awsui_position-side_hyvsj_homer_857.awsui_animating_hyvsj_homer_630:not(#\9), .awsui-mode-entering section.awsui_split-panel-side_hyvsj_homer_830.awsui_is-split-panel-open_hyvsj_homer_515.awsui_position-side_hyvsj_homer_857.awsui_animating_hyvsj_homer_630:not(#\9) {
  animation: none;
  transition: none;
}
section.awsui_split-panel-side_hyvsj_homer_830 > .awsui_animated-content_hyvsj_homer_690:not(#\9) {
  height: 100%;
  max-width: inherit;
  width: var(--awsui-split-panel-reported-size-ujkcpl);
}
...
*/
.awsui_tools-container_hyvsj_homer_894:not(#\9) {
...
.awsui_tools_hyvsj_homer_894:not(#\9) {
  background-color: var(--color-background-container-content-o88wxm, #ffffff);
  box-shadow: var(--shadow-panel-v9vx7i, 0 1px 1px 0 rgba(0, 28, 36, 0.3), 1px 1px 1px 0 rgba(0, 28, 36, 0.15), -1px 1px 1px 0 rgba(0, 28, 36, 0.15));
  flex-shrink: 0;
  height: 100%;
...
@keyframes awsui_openTools_hyvsj_homer_1 {
  from {
...
.awsui_tools_hyvsj_homer_894:not(#\9):not(.awsui_is-tools-open_hyvsj_homer_515) {
  width: 0;
  display: none;
}
.awsui_tools_hyvsj_homer_894.awsui_is-tools-open_hyvsj_homer_515.awsui_animating_hyvsj_homer_630:not(#\9) {
  animation: awsui_openTools_hyvsj_homer_1 var(--motion-duration-refresh-only-fast-addxjd, 115ms);
}
@media (prefers-reduced-motion: reduce) {
  .awsui_tools_hyvsj_homer_894.awsui_is-tools-open_hyvsj_homer_515.awsui_animating_hyvsj_homer_630:not(#\9) {
    animation: none;
...
.awsui-motion-disabled .awsui_tools_hyvsj_homer_894.awsui_is-tools-open_hyvsj_homer_515.awsui_animating_hyvsj_homer_630:not(#\9), .awsui-mode-entering .awsui_tools_hyvsj_homer_894.awsui_is-tools-open_hyvsj_homer_515.awsui_animating_hyvsj_homer_630:not(#\9) {
  animation: none;
  transition: none;
}
.awsui_tools_hyvsj_homer_894 > .awsui_animated-content_hyvsj_homer_690:not(#\9) {
  width: var(--awsui-tools-width-ujkcpl);
}
@media (min-width: 689px) {
  .awsui_tools_hyvsj_homer_894.awsui_is-tools-open_hyvsj_homer_515.awsui_has-tools-form-persistence_hyvsj_homer_977:not(#\9) {
...
.awsui_hide-tools_hyvsj_homer_987:not(#\9) {
  position: absolute;
  right: var(--space-m-17eucw, 16px);
  top: var(--size-vertical-panel-icon-offset-ti40n4, 15px);
  z-index: 1;
...
handleSplitPanelMaxWidth function in the context.
*/
.awsui_show-tools_hyvsj_homer_999:not(#\9) {
  box-sizing: border-box;
  padding: var(--space-scaled-s-cu1hzn, 12px) var(--space-layout-toggle-padding-axl9jr, 20px);
  /*
  Apply the animation only in desktop viewports because the AppBar will 
...
.awsui_show-tools_hyvsj_homer_999:not(#\9):not(.awsui_has-tools-form_hyvsj_homer_977) {
  display: none;
}
@media (min-width: 689px) {
  .awsui_show-tools_hyvsj_homer_999.awsui_has-tools-form_hyvsj_homer_977:not(#\9) {
    display: flex;
    flex-direction: column;
    gap: var(--space-xs-rsr2qu, 8px);
  }
  .awsui_show-tools_hyvsj_homer_999.awsui_has-tools-form_hyvsj_homer_977.awsui_animating_hyvsj_homer_630:not(#\9) {
    animation: awsui_showButtons_hyvsj_homer_1 var(--motion-duration-refresh-only-fast-addxjd, 115ms);
  }
}
@media (min-width: 689px) and (prefers-reduced-motion: reduce) {
...
@media (min-width: 689px) {
  .awsui-motion-disabled .awsui_show-tools_hyvsj_homer_999.awsui_has-tools-form_hyvsj_homer_977.awsui_animating_hyvsj_homer_630:not(#\9), .awsui-mode-entering .awsui_show-tools_hyvsj_homer_999.awsui_has-tools-form_hyvsj_homer_977.awsui_animating_hyvsj_homer_630:not(#\9) {
    animation: none;
    transition: none;
  }
}
@media (min-width: 689px) {
  .awsui_show-tools_hyvsj_homer_999.awsui_has-tools-form-persistence_hyvsj_homer_977:not(#\9) {
    background-color: var(--color-background-container-content-o88wxm, #ffffff);
    z-index: 1;
  }
}
...
handleSplitPanelMaxWidth function in the context.
*/
.awsui_trigger_hyvsj_homer_1056:not(#\9) {
...
.awsui_trigger_hyvsj_homer_1056[data-awsui-focus-visible=true]:not(#\9):focus {
  position: relative;
}
.awsui_trigger_hyvsj_homer_1056[data-awsui-focus-visible=true]:not(#\9):focus {
...
.awsui_trigger_hyvsj_homer_1056[data-awsui-focus-visible=true]:not(#\9):focus::before {
  content: " ";
  display: block;
  position: absolute;
  left: calc(-1 * 3px);
...
.awsui_trigger_hyvsj_homer_1056:not(#\9):focus {
  outline: none;
}
.awsui_trigger_hyvsj_homer_1056:not(#\9):hover {
  background: var(--color-background-layout-toggle-hover-5rvtea, #545b64);
}
.awsui_trigger_hyvsj_homer_1056:not(#\9):active {
  background: var(--color-background-layout-toggle-active-d3zrnd, #2a2e33);
}
.awsui_trigger_hyvsj_homer_1056.awsui_selected_hyvsj_homer_1094:not(#\9) {
...
.awsui_trigger_hyvsj_homer_1056.awsui_selected_hyvsj_homer_1094:not(#\9):hover {
  background: var(--color-background-layout-toggle-selected-hover-vtsm2f, #0a4a74);
}
.awsui_trigger_hyvsj_homer_1056.awsui_selected_hyvsj_homer_1094:not(#\9):active {

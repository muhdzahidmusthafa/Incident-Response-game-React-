 ...
 */
export declare const useLoadItems: (onLoadItems: PropertyFilterProps['onLoadItems'], focusFilteringText?: string | undefined, currentFilteringProperty?: import("@awsui/collection-hooks").PropertyFilterProperty | undefined, currentFilteringText?: string | undefined, currentFilteringOperator?: import("@awsui/collection-hooks").PropertyFilterOperator | undefined) => {
    onBlur: () => void;
    onFocus: () => void;

...
export declare const parseText: (filteringText: string, filteringProperties: readonly import("@awsui/collection-hooks").PropertyFilterProperty[] | undefined, disableFreeTextFiltering: boolean) => ParsedText;
export declare const getPropertyOptions: (filteringProperty: PropertyFilterProps.FilteringProperty, filteringOptions: PropertyFilterProps['filteringOptions']) => import("@awsui/collection-hooks").PropertyFilterOption[] | undefined;
...
export declare const getPropertyByKey: (filteringProperties: PropertyFilterProps['filteringProperties'], key: string) => import("@awsui/collection-hooks").PropertyFilterProperty | undefined;

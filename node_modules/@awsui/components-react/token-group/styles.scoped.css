...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
.awsui_root_dm8gx_15qqo_97:not(#\9) {
...
.awsui_root_dm8gx_15qqo_97.awsui_has-items_dm8gx_15qqo_107:not(#\9) {
  padding-top: var(--space-xs-rsr2qu, 8px);
}

.awsui_token_dm8gx_15qqo_111:not(#\9) {
  border: var(--border-field-width-y6x4sn, 1px) solid var(--color-border-item-selected-pr9yuf, #00a1c9);
  padding: var(--space-scaled-xxs-95dhkm, 4px) var(--space-xxs-ynfts5, 4px) var(--space-scaled-xxs-95dhkm, 4px) var(--space-field-horizontal-z3i1c8, 8px);
  display: flex;
  align-items: flex-start;
  background: var(--color-background-item-selected-fva7ca, #f1faff);
  border-radius: var(--border-radius-token-3ax3p2, 2px);
  color: var(--color-text-body-default-7m2b3r, #16191f);
  height: 100%;
  box-sizing: border-box;
}

.awsui_dismiss-button_dm8gx_15qqo_123:not(#\9) {
...
.awsui_dismiss-button_dm8gx_15qqo_123[data-awsui-focus-visible=true]:not(#\9):focus {
  position: relative;
}
.awsui_dismiss-button_dm8gx_15qqo_123[data-awsui-focus-visible=true]:not(#\9):focus {
...
.awsui_dismiss-button_dm8gx_15qqo_123[data-awsui-focus-visible=true]:not(#\9):focus::before {
  content: " ";
  display: block;
  position: absolute;
  left: calc(-1 * 0px);
...
.awsui_dismiss-button_dm8gx_15qqo_123:not(#\9):focus {
  outline: none;
  text-decoration: none;
}
.awsui_dismiss-button_dm8gx_15qqo_123:not(#\9):hover {
  cursor: pointer;
  color: var(--color-text-button-inline-icon-hover-84mkuo, #16191f);
}

.awsui_token-disabled_dm8gx_15qqo_157:not(#\9) {
...
.awsui_token-disabled_dm8gx_15qqo_157 > .awsui_dismiss-button_dm8gx_15qqo_123:not(#\9) {
  color: var(--color-text-button-inline-icon-disabled-sesloi, #aab7b8);
}
.awsui_token-disabled_dm8gx_15qqo_157 > .awsui_dismiss-button_dm8gx_15qqo_123:not(#\9):hover {
  /* stylelint-disable-next-line plugin/no-unsupported-browser-features */
  cursor: auto;
  color: var(--color-text-button-inline-icon-disabled-sesloi, #aab7b8);
}

.awsui_toggle_dm8gx_15qqo_172:not(#\9) {
  /* stylelint-disable-next-line plugin/no-unsupported-browser-features */
  border-collapse: separate;
  border-spacing: 0;
  caption-side: top;
...
.awsui-motion-disabled .awsui_toggle_dm8gx_15qqo_172:not(#\9), .awsui-mode-entering .awsui_toggle_dm8gx_15qqo_172:not(#\9) {
  animation: none;
  transition: none;
}
.awsui_toggle_dm8gx_15qqo_172:not(#\9):hover {
  cursor: pointer;
  color: var(--color-text-link-hover-ok01xk, #0073bb);
}
.awsui_toggle_dm8gx_15qqo_172:not(#\9):focus {
  outline: none;
}
.awsui_toggle_dm8gx_15qqo_172:not(#\9):active {
  color: var(--color-text-link-hover-ok01xk, #0073bb);
}
.awsui_toggle_dm8gx_15qqo_172:not(#\9):active, .awsui_toggle_dm8gx_15qqo_172:not(#\9):focus, .awsui_toggle_dm8gx_15qqo_172:not(#\9):hover {
...
.awsui_toggle_dm8gx_15qqo_172[data-awsui-focus-visible=true]:not(#\9):focus {
  outline: 2px dotted transparent;
...
.awsui_toggle_dm8gx_15qqo_172 > .awsui_description_dm8gx_15qqo_233:not(#\9) {
